...
# Anti-immigrant Sentinment v. To What Degree (Non-immigrant)
ggplot()+
  geom_point(aes(x= mydata2$antimm, y= mydata2$twd))+
  labs(x= "Anti-immigrant Sentinment", y= "To What Degree Scale", 
       title= "Relationship between Belonging and To What Degree Scale (Non-immigrant)")+
  theme_classic() +
  scale_x_continuous(breaks=seq(0,25,5)) +
  scale_y_continuous(breaks=seq(0,16,2))

# Anti-immigrant Sentinment v. Threat
ggplot()+
  geom_point(aes(x= mydata2$antimm, y= mydata2$threat))+
  labs(x= "Anti-immigrant Sentinment", y= "Sense of Threat", 
       title= "Relationship between Anti-Immigrant Sentiment and Sense of Threat")+
  theme_classic() +
  scale_x_continuous(breaks=seq(0,25,5)) +
  scale_y_continuous(breaks=seq(0,18,2))

# Anti-immigrant Sentinment v. Benefit
ggplot()+
  geom_point(aes(x= mydata2$antimm, y= mydata2$benefit))+
  labs(x= "Anti-immigrant Sentinment", y= "Sense of Benefit", 
       title= "Relationship between Belonging and Sense of Benefit")+
  theme_classic() +
  scale_x_continuous(breaks=seq(0,25,5)) +
